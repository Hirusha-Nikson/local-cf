...
export const metadata = {
  title: "Modes A / B / C",
  description:
    "The three ways local-cf reaches your bindings — a shared workerd runtime, attaching to another dev server's persisted state, or the Cloudflare REST API — and what each one actually guarantees.",
  alternates: { canonical: "/docs/modes" },
  openGraph: {
    type: "article",
    url: "/docs/modes",
    title: "Modes A / B / C · local-cf",
    description:
      "Shared runtime, attached, or remote. They are not equivalent, and every binding is labelled with which one is in play.",
  },
};

<DocsJsonLd path="/docs/modes" description={metadata.description} />
